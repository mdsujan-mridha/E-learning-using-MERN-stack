...
function CourseDetails() {
  ...
  //     const courseData = {
  //       courseId: courseId, // Assuming courseId is obtained from useParams()
  //       userId: user._id,   // Assuming user is fetched from your Redux state
  //       amount: price,      // Assuming price is obtained from the course details
  //     };
  
  //     // Make an API call to your backend to initialize the payment
  //     const { data } = await axios.post(
  //       `http://localhost:5000/api/v1/payment/capturePayment`,
  //       courseData,
  //       {
  //         headers: {
